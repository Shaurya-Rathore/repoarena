...
| Cloud database and migrations | VERIFIED | `packages/cloud-db`, migrations 0001–0007, guarded PostgreSQL fixtures | cloud-db unit/integration; `pnpm db:migrate` | PostgreSQL 18 fresh/upgrade migration, constraints, rollback and advisory locking pass against `repoarena_test`. |
